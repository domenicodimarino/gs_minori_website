...
<html>
    ...
    <body>
        ...
        <div class="team-title"> <strong>PRIMA SQUADRA MASCHILE</strong></div> <br>
        <nav class="sub-nav">
            <a href="#playmaker" class="nav-link"> PLAYMAKER</a> | 
            <a href="#guardia" class="nav-link"> GUARDIA</a> | 
            <a href="#alapiccola" class="nav-link"> ALA PICCOLA</a> |
            <a href="#alagrande" class="nav-link"> ALA GRANDE</a> |
            <a href="#centro" class="nav-link"> CENTRO</a> |
            <a href="#allenatore" class="nav-link"> ALLENATORE</a>
        </nav>
        <br>
        ...
        <p class="position-title">PLAYMAKER</p>
            <div id="playmaker" class="geppetto">
                    <div class="image-container">
                    <img src="photo_teams/alemammato.png" alt="immagine" class="image">
                    <div class="text"> 34 <br> Alessandro  <br>Mammato</div>
                    </div>
            </div>
        <p class="position-title">GUARDIA</p>
            <div id="guardia" class="geppetto">
                <div class="image-container">
        ...
        <p class="position-title">ALA PICCOLA</p>
            <div id="alapiccola" class="geppetto">
                <div class="image-container">
        ...
        <p class="position-title">ALA GRANDE</p>
        ...
        <p class="position-title">CENTRO</p>
            <div id="centro" class="geppetto">
                <div class="image-container">
        ...
        <div class="text2">
            ...
            <div class="description">
                <p class="bold">Biografia di Jacopo Porpora</p><br>
